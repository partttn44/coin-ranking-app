...
abstract class AppLocalizations {
  ...
  /// No description provided for @unableToLoadCoins.
  ///
  /// In en, this message translates to:
  /// **'Unable to load coins.'**
  String get unableToLoadCoins;

  /// No description provided for @unableToLoadCoinDetail.
  ///
  /// In en, this message translates to:
  /// **'Unable to load coin details.'**
  String get unableToLoadCoinDetail;

  /// No description provided for @emptyCoins.
  ///
  /// In en, this message translates to:
  /// **'No coins found'**
  String get emptyCoins;
